...
- The first real modules are `keytab`, `krb5.conf`, `ccache`, `crypto`,
  ...
  preserve gokrb5 EncryptedData signed-kvno DER edge fixtures, PA-FOR-USER, PA-PAC-OPTIONS, PA-REQ-ENC-PA-REP, and KRB-ERROR timing diagnostics; KRB-CRED helpers decode gokrb5 fixtures, decrypt EncKrbCredPart, and convert decrypted tickets to ccache credentials; kadmin covers
