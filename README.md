...
- The first real modules are `keytab`, `krb5.conf`, `ccache`, `crypto`,
  ...
  preserve gokrb5 EncryptedData signed-kvno DER edge fixtures, PA-FOR-USER, PA-PAC-OPTIONS, PA-REQ-ENC-PA-REP, KRB-ERROR timing diagnostics, and generic AP-REP decode/decrypt/build helpers; KRB-SAFE decodes gokrb5 fixtures and verifies keyed checksums; KRB-CRED helpers decode gokrb5 fixtures, decrypt EncKrbCredPart, and round-trip ccache credentials through encrypted KRB-CRED import/export; kadmin covers
