...
- The first real modules are `keytab`, `krb5.conf`, `ccache`, `crypto`,
  ...
  coverage, configured kpasswd transport, typed kpasswd request/reply/result exchanges, and complete kpasswd request assembly with generated reply keys, `krb5.conf` configured KDC
